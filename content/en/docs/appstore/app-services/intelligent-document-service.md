...
6.  Drag sample images in JPG, JPEG, BMP or PNG format into the box where it says **Drag and drop image files here**. You can also click **Browse** and select the files.
...
1.  To create an import mapping, you need a JSON structure. Perform the following steps to generate the JSON structure:
    ...
    5.  Drag one of the sample input file, which you used to train the document model, into the box where it says **Drag and drop files here**. You can also click **Browse** and select the file.
